...
- [x] 写入并自检跨仓设计文档。
- [x] 用户审阅设计文档并确认继续。
- [x] 编写并自检第一批实施计划：`docs/superpowers/plans/2026-07-23-android-historical-group-read-routing.md`。
...
- 第一批 metadata 显式携带成员修改能力；Android 返回不支持，避免只读接通后误开放写按钮。
