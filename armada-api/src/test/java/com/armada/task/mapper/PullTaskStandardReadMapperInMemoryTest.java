...
class PullTaskStandardReadMapperInMemoryTest {
    ...
    private void seedFacts() throws SQLException {
        ...
        execute("INSERT INTO pull_task_material_member "
                ...
                + "pull_status, created_at, updated_at) VALUES "
                + "(7, 11, 1, 1, '861', 2, 1, 1),"
                + "(7, 11, 2, 2, '862', 2, 1, 1),"
                + "(7, 12, 1, 1, '863', 3, 1, 1),"
                + "(7, 12, 2, 2, '864', 4, 1, 1),"
        ...
        execute("INSERT INTO pull_task_group_account "
                ...
                + "(7, 100, 11, 500, '500', 1, 1, 2, 1, NULL, 1, 1),"
                + "(7, 100, 11, 501, '501', 2, 1, 2, 1, 1, 1, 1),"
                + "(7, 100, 12, 502, '502', 2, 1, 2, 3, 1, 1, 1),"
                + "(8, 200, 21, 503, '503', 2, 1, 2, 1, 1, 1, 1)");
    }
