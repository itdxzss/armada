...
class AccountContactNormalizerTest {
    ...
    void emptyAndNullSnapshotsProduceZeroCounts() {
        assertThat(normalizer.normalize(new AccountContactSnapshot(List.of())).contactNum())
                .isZero();
        assertThat(normalizer.normalize(new AccountContactSnapshot(null)).contactNum())
                .isZero();
