...
public final class PullTaskNormalLinkSchema {
    ...
    static final String STANDARD_SETTING = """
            CREATE TABLE pull_task_standard_setting (
                ...
                is_creator_leave_after_pull TINYINT NOT NULL DEFAULT 0,
    ...
    static final String GROUP_EXECUTION = """
            CREATE TABLE pull_task_group_execution (
                ...
                creator_leave_result TINYINT NOT NULL DEFAULT 0,
                creator_leave_reason VARCHAR(255),
